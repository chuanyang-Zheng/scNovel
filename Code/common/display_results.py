...
def print_measures(auroc, aupr, fpr, method_name='Ours', recall_level=recall_level_default,log_path=None):
    print('    ' + method_name+"\n")
...
def print_measures_with_std(aurocs, auprs, fprs, method_name='Ours', recall_level=recall_level_default,log_path=None):
    # print(100 * recall_level)
    print('    ' + method_name+"\n")
    print('FPR{:d}:   {:.2f} + /- {:.2f}\n'.format(int(100 * recall_level), 100 * np.mean(fprs), 100 * np.std(fprs)))
    print('AUROC:    {:.2f} +/- {:.2f}\n'.format(100 * np.mean(aurocs), 100 * np.std(aurocs)))
    print('AUPR:     {:.2f} +/- {:.2f}\n'.format(100 * np.mean(auprs), 100 * np.std(auprs)))
